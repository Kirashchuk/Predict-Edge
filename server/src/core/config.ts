...
const schema = z.object({
  ...
  ARC_RPC_URL: z
    .string()
    .default(process.env.DEPLOY_RPC_URL || 'https://rpc.testnet.arc.network'),
...
export const env = schema.parse({
  ...
  ARC_RPC_URL: process.env.ARC_RPC_URL || process.env.DEPLOY_RPC_URL,
  PRIVATE_KEY: process.env.PRIVATE_KEY,
  FINDER_ADDRESS: process.env.DEPLOY_FINDER_ADDRESS,
  TIMER_ADDRESS: process.env.DEPLOY_TIMER_ADDRESS,
});
